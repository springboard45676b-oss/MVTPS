...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-maritime-vessel-tracking-dev-key-change-in-production')
...
# CORS Configuration
CORS_ALLOWED_ORIGINS = os.getenv('CORS_ORIGINS', 'http://localhost:3000,http://127.0.0.1:5500,http://localhost:5500').split(',')
