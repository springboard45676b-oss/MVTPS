...
const TopProfileCircle = () => {
  ...
  return (
    <div className="top-profile-circle">
      <div 
      ...
      >
        <div className="profile-circle-avatar">
          ...
          {/* Notification Badge */}
          {unreadCount > 0 && (
            <span className="profile-circle-badge">
              {unreadCount > 99 ? '99+' : unreadCount}
            </span>
          )}
        </div>
        
        <div className="profile-circle-info">
          <div className="profile-circle-name">
            {user?.first_name ? `${user.first_name} ${user.last_name}` : user?.username}
          </div>
          <div className="profile-circle-role">{user?.role}</div>
        </div>
        
        <span className="profile-circle-dropdown-arrow">▼</span>
      </div>
      ...
      {showDropdown && (
        <>
          ...
          />
          <div className="profile-circle-dropdown">
...
export default TopProfileCircle;