...
# # ✅ FIXED: Proper ALLOWED_HOSTS for WebSocket
# ALLOWED_HOSTS = [
#     'localhost',
#     '127.0.0.1',
#     '127.0.0.1:8000',
...
#     'corsheaders',
#     'django_filters',
#     'channels',  # ✅ WebSocket support via Channels
#     # Local apps
#     'core',
# ]
...
# # ✅ ASGI Application (for WebSocket support with Uvicorn)
...
# # Production: Redis (uncomment below)
# # CHANNEL_LAYERS = {
# #     'default': {
...
# # Suppress non-critical Uvicorn warnings
# LOGGING = {
#     'version': 1,
...
CORS_ALLOWED_ORIGINS = [
    ...
    'http://localhost:5173',
    'http://127.0.0.1:5173',
    'https://mvtps-vesseltrackingplatform-client.onrender.com',
]
