    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vessel_type', models.CharField(choices=[('cargo', 'Cargo Ship'), ('container', 'Container Ship'), ('tanker', 'Tanker'), ('bulk', 'Bulk Carrier'), ('passenger', 'Passenger Ship'), ('fishing', 'Fishing Vessel'), ('other', 'Other')], max_length=20)),
