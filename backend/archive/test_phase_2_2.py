...
def test_new_app_functionality():
    ...
    try:
        ...
        print(f"✅ Database access works - Voyages: {voyage_count}, Positions: {position_count}, Violations: {violation_count}")
        
        return True
    except Exception as e:
        print(f"❌ New app functionality failed: {e}")
        return False
...
def test_backward_compatibility():
    ...
    try:
        ...
        print("✅ Backward compatible imports from vessels app work")
        ...
        print("✅ Bridge imports work correctly")
...
def test_app_registration():
    ...
    try:
        ...
        print(f"✅ voyage_history app registered: {voyage_app.verbose_name}")
        
        # Check if models are registered
        models = voyage_app.get_models()
        model_names = [model.__name__ for model in models]
        print(f"✅ Models registered: {model_names}")
...
def test_database_integrity():
    ...
    try:
        ...
        print(f"✅ Database queries work - Found {len(voyages)} voyages, {len(positions)} positions, {len(violations)} violations")
        ...
        if voyages.exists():
            ...
            print(f"✅ Model relationships work - Voyage {voyage.voyage_id} has {len(voyage_positions)} positions and {len(voyage_violations)} violations")
...
def test_api_endpoints():
    ...
    try:
        ...
        print(f"✅ New voyage-history API endpoint accessible (status: {response.status_code})")
        
        # Test vessels endpoints (backward compatibility)
        response = client.get('/api/vessels/voyage-replay/')
        print(f"✅ Old vessels API endpoint accessible (status: {response.status_code})")
...
def test_admin_integration():
    ...
    try:
        ...
        print(f"❌ Admin integration failed: {e}")
        return False
